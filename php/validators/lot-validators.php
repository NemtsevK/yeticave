...
function validateLotForm(array $form_data, array $files): array
{
    $errors = [];
    $required = ['title', 'category_id', 'description', 'price', 'step', 'finish_date', 'image'];

    $errors['title'] = validateLotTitle($form_data['title']);
    $errors['category_id'] = validateLotCategory($form_data['category_id']);
    $errors['description'] = validateLotDescription($form_data['description']);
    $errors['price'] = validateLotPrice($form_data['price']);
    $errors['step'] = validateLotStep($form_data['step']);
    $errors['finish_date'] = validateLotFinishDate($form_data['finish_date']);
